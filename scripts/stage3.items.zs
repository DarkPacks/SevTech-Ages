...
var stage3Items = [
	...
	<materialpart:cobalt:beam>.getItemStack(),
	...
	<materialpart:redstone_alloy:bolt>.getItemStack(),
	<materialpart:silver:beam>.getItemStack(),
	<materialpart:silver:bolt>.getItemStack(),
