...
addContainerToStages("primal_tech.inventory.ContainerWorkStump", [stageTutorial, stageZero, stageBaykok]);

/*
	Package Staging
*/
// AE Crafting Terminal
addPackageToStages("appeng", ALL_STAGES);

// RS Crafting Grid
addPackageToStages("com.raoulvdberge.refinedstorage", ALL_STAGES);

// RFtools Crafters
addPackageToStages("mcjty.rftools.blocks.crafter", ALL_STAGES);

// Inductive Logistics Automatic Crafters
addPackageToStages("cd4017be.lib.Gui", [stageTutorial, stageBaykok, stageZero, stageOne, stageTwo, stageThree, stageFour]);

// Auto Workbench Buildcraft
addPackageToStages("buildcraft.lib.tile.craft.WorkbenchCrafting", [stageTutorial, stageBaykok, stageZero, stageOne, stageTwo, stageThree, stageFour]);

// Cyclic Auto Crafter
addPackageToStages("com.lothrazar.cyclicmagic.component.crafter.TileEntityCrafter", ALL_STAGES);
