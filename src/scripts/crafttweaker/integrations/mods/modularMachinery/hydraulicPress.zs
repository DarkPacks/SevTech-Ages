...
static recipes as IItemStack[][IItemStack] = {
	...
	<galacticraftcore:item_basic_moon:1> * 2: [	<galacticraftcore:item_basic_moon:0> * 2 ], // Compressed Meteoric Iron
	...
	<extraplanets:compressed_mercury:0>: [ <extraplanets:ingot_mercury:0> * 2 ], // Compressed Mercury
