...
static shapedRecipes as IIngredient[][][IItemStack][int] = {
	...
	0:{
		...
		<environmentaltech:modifier_creative_flight:0>: [
			...
			[<environmentaltech:mica:0>, <mekanism:controlcircuit:3>, <extendedcrafting:singularity_custom:2>, <minecraft:dye:0>, <nex:food_meat_ghast_cooked:0>, <minecraft:dye:0>, <extendedcrafting:singularity_custom:2>, <mekanism:controlcircuit:3>, <environmentaltech:mica:0>],
			...
			[<actuallyadditions:block_player_interface:0>, <bloodmagic:sigil_phantom_bridge:0>, <nex:food_meat_ghast_cooked:0>, <bloodmagic:sigil_air:0>, <rftools:flight_module:0>, <bloodmagic:sigil_air:0>, <nex:food_meat_ghast_cooked:0>, <bloodmagic:sigil_phantom_bridge:0>, <actuallyadditions:block_player_interface:0>],
			[<environmentaltech:mica:0>, <mekanism:controlcircuit:3>, <minecraft:dye:0>, <extendedcrafting:singularity_custom:2>, <bloodmagic:sigil_air:0>, <extendedcrafting:singularity_custom:2>, <minecraft:dye:0>, <mekanism:controlcircuit:3>, <environmentaltech:mica:0>],
			[<environmentaltech:mica:0>, <mekanism:controlcircuit:3>, <extendedcrafting:singularity_custom:2>, <minecraft:dye:0>, <nex:food_meat_ghast_cooked:0>, <minecraft:dye:0>, <extendedcrafting:singularity_custom:2>, <mekanism:controlcircuit:3>, <environmentaltech:mica:0>],
