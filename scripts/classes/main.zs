...
// Mods
global abyssalcraft as scripts.classes.mods.abyssalcraft.AbyssalCraft = scripts.classes.mods.abyssalcraft.AbyssalCraft(0.5f);
global actuallyAdditions as scripts.classes.mods.actually_additions.ActuallyAdditions = scripts.classes.mods.actually_additions.ActuallyAdditions();
